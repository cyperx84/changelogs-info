...

{
  ...
  "tldr": "10-14 sentence plain-English release summary for a developer deciding whether to upgrade. Start with the headline change in 2-3 sentences explaining what it is and why it matters. Then dedicate 2-3 sentences each to: major new features and what workflows they enable, important fixes and their impact, and any breaking changes or migration steps with specific commands. Cover every meaningful change — not just the top 3. Include concrete behavior changes, config paths, CLI flags, and code examples where relevant. End with 1-2 sentences on recommended upgrade urgency and any prerequisites. Make it detailed enough that a developer can understand the full scope of the release without reading the changelog. Do not omit significant changes to save space."
}
